import { BackendSecret, ConstructFactory, FunctionResources, ResourceAccessAcceptorFactory, ResourceProvider } from '@aws-amplify/plugin-types';
 ...
 */
export declare const defineFunction: (props?: FunctionProps) => ConstructFactory<ResourceProvider<FunctionResources> & ResourceAccessAcceptorFactory & AddEnvironmentFactory>;
